...
public interface SupplierInfoService {
    ...
    List<SupplierListVO> supplierListByPage(Integer pageIndex, Integer pageSize,SupplierInfoDTO supplierInfoDTO); //取供应商列表
    ...
    SupplierInfo supplierInfoById(SupplierInfoDTO supplierInfoDto); //查询供应商详情
