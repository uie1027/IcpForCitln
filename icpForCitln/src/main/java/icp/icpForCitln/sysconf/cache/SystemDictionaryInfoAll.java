...
package icp.icpForCitln.sysconf.cache;
...
public class SystemDictionaryInfoAll extends BaseEntity implements Serializable {

    private static final long serialVersionUID = -7898194272883238670L;

    private static final String OBJECT_KEY = "SYSTEM_DICTIONARY_INFO_ALL";
